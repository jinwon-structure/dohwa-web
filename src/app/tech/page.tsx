...
const services = [
    ...
    },
    {
        ...
        desc: "도화기술은 엔지니어의 통찰력에 AI의 연산력을 더해, 건설 IT의 새로운 표준을 세웁니다. 다양한 설계 대안을 즉각 도출하고, 공기 단축, 물량 절감, 탄소 중립을 동시에 실현합니다. 단순 반복 업무는 AI가 처리하고, 전문가는 창의적 판단에 몰입합니다.",
                ...
                <div className={styles.featuredCard}>
                    ...
                    <div className={styles.featuredContent}>
                        <div className={styles.featuredIcon}>
                            <Blocks size={64} strokeWidth={1.5} />
                        </div>
